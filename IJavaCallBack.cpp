...
struct IJavaCallBack* IJavaCallBack_defalut_allocate() {
    ...
    callback->init = JavaCallBackEx_default_init;
    callback->reset = JavaCallBackEx_default_reset;
    callback->free = JavaCallBackEx_default_free;

    callback->callMethod    = JavaCallBackEx_default_callMethod;
    callback->callMethodL   = JavaCallBackEx_default_callMethodL;
    callback->callMethodI   = JavaCallBackEx_default_callMethodI;
    callback->callMethodZ   = JavaCallBackEx_default_callMethodZ;

    callback->callMethodIZ  = JavaCallBackEx_default_callMethodIZ ;
    callback->callMethodII  = JavaCallBackEx_default_callMethodII;
    callback->callMethodJJ  = JavaCallBackEx_default_callMethodJJ;
    callback->callMethodFF  = JavaCallBackEx_default_callMethodFF;

    callback->callMethodIII = JavaCallBackEx_default_callMethodIII;
    callback->callMethodIFF = JavaCallBackEx_default_callMethodIFF;
    callback->callMethodFFF = JavaCallBackEx_default_callMethodFFF;

    callback->callMethodFFFF = JavaCallBackEx_default_callMethodFFFF;
    callback->callMethodIFFF = JavaCallBackEx_default_callMethodIFFF;
    callback->callMethodIIFF = JavaCallBackEx_default_callMethodIIFF;

    callback->callMethodI_F_F = JavaCallBackEx_default_callMethodI_F_F;
    callback->callMethod_F_F  = JavaCallBackEx_default_callMethod_F_F;
    callback->callMethod_FI   = JavaCallBackEx_default_callMethod_FI;
    callback->callMethodOJZ   = JavaCallBackEx_default_callMethodOJZ;

    callback->callMethodIIIFF = JavaCallBackEx_default_callMethodIIIFF;
